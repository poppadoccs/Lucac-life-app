...
import { callAI, verifyMath, createSpeechRecognition, triggerConfetti, speakText, detectUnsafeInput, SAFETY_RESPONSE_TEXT } from "./utils";
...
// BF-0: the deterministic kid-safety guard (SAFETY_RESPONSE_TEXT,
// UNSAFE_INPUT_PATTERNS, detectUnsafeInput) moved to utils.js in S07 so the
// Jr assistant path (aiAgent.js) shares the exact same guard. The doAICall
// hook below is unchanged — it now imports the guard instead of owning it.
