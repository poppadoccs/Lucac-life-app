...
export default function LifeApp() {
  ...
  const tabs = isKid
    ...
    : [{id:"home",icon:"🏠",label:"Home"},{id:"food",icon:"🍽️",label:"Food"},{id:"nutrition",icon:"🔥",label:"Nutrition"},{id:"goals",icon:"🎯",label:"Goals"},{id:"kids",icon:"⭐",label:"Kids"},{id:"calendar",icon:"📅",label:"Calendar"},{id:"routines",icon:"🔄",label:"Routines"},
